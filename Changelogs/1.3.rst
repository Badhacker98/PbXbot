...
* **Major Updates:**
     ...
     *For Example:* ``GIT_REPO`` = ``Badhacker98/Plugins``
...
+-------------------------------------------------------------------------------------------------------------------------------------------------------+
| **IMPORTANT:** *I'm planning to add pyrogram version of PbxBot. Any developer who knows Pyrogram and is willing to help you're most welcome.*        |
| *Connect with me on telegram through PbxBot Support Chat. Also, I'm not expecting newbies! Someone who can code a plugin in pyrogram is good enough* |
+-------------------------------------------------------------------------------------------------------------------------------------------------------+
...
By ~ `🕊️⃝‌ᴘʙx ❤️ᥫ᭡፝֟፝֟ɴᴇᴛᴡᴏʀᴋ { 🇮🇳 } <https://t.me/ll_THE_BAD_BOT_ll>`_
=================================================
